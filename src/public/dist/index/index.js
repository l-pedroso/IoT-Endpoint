...
})({"7nvr3":[function(require,module,exports) {
var HMR_HOST = null;
var HMR_PORT = 1234;
var HMR_SECURE = false;
var HMR_ENV_HASH = "d751713988987e9331980363e24189ce";
module.bundle.HMR_BUNDLE_ID = "052b5d0d89a05e017957a98113e98b83";
// @flow
...
},{}],"Ly4Gq":[function(require,module,exports) {
...
},{"@auth0/auth0-spa-js":"2h22p","@parcel/transformer-js/lib/esmodule-helpers.js":"5gA8y"}],"2h22p":[function(require,module,exports) {
"use strict";
...
var createMethod$1 = function (TYPE) {
  ...
  return function ($this, callbackfn, that, specificCreate) {
    ...
    for (; length > index; index++) if (NO_HOLES || (index in self)) {
      ...
      if (TYPE) {
        if (IS_MAP) target[index] = result; else // map
...
* @ignore
*/
var RECOVERABLE_ERRORS = ['login_required', 'consent_required', 'interaction_required', 'account_selection_required', // Strictly speaking the user can't recover from `access_denied` - but they
...
var fetchWithoutWorker = function (fetchUrl, fetchOptions, timeout) {
  return __awaiter(void 0, void 0, void 0, function () {
    ...
    return __generator(this, function (_a) {
      ...
      return [2, /*return*/
      Promise.race([dofetch(fetchUrl, fetchOptions), new Promise(function (_, reject) {
...
var fetchWithWorker = function (fetchUrl, audience, scope, fetchOptions, timeout, worker) {
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      return [2, /*return*/
      sendMessage({
...
var switchFetch = function (fetchUrl, audience, scope, fetchOptions, worker, timeout) {
  ...
  return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
      if (worker) {
        return [2, /*return*/
        fetchWithWorker(fetchUrl, audience, scope, fetchOptions, timeout, worker)];
      } else {
        return [2, /*return*/
    ...
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          ...
          _b.label = 1;
        case 1:
          if (!(i < DEFAULT_SILENT_TOKEN_RETRY_COUNT)) return [3, /*break*/
          6];
          _b.label = 2;
        case 2:
          _b.trys.push([2, 4, , 5]);
  ...
  return __awaiter(this, void 0, void 0, function () {
    return __generator(this, function (_b) {
      switch (_b.label) {
        case 0:
          return [4, /*yield*/
          getJSON(baseUrl + "/oauth/token", timeout, audience || 'default', scope, {
            method: 'POST',
...
var findExistingCacheKey = function (cacheKey, existingCacheKeys) {
  var client_id = cacheKey.client_id, audience = cacheKey.audience, scope = cacheKey.scope;
  return existingCacheKeys.filter(function (key) {
    var _a = CacheKey.fromKey(key), currentPrefix = _a.prefix, currentClientId = _a.client_id, currentAudience = _a.audience, currentScopes = _a.scope;
    var currentScopesArr = currentScopes && currentScopes.split(' ');
    var hasAllScopes = currentScopes && scope.split(' ').reduce(function (acc, current) {
      return acc && currentScopesArr.includes(current);
    }, true);
    return currentPrefix === keyPrefix && currentClientId === client_id && currentAudience === audience && hasAllScopes;
  })[0];
};
...
(function () {
  ...
  LocalStorageCache.prototype.get = function (cacheKey, expiryAdjustmentSeconds) {
  ...
  */
  LocalStorageCache.prototype.readJson = function (cacheKey) {
    var existingCacheKey = findExistingCacheKey(cacheKey, Object.keys(window.localStorage));
    var json = existingCacheKey && window.localStorage.getItem(existingCacheKey);
    var payload;
    if (!json) {
      return;
    }
    ...
    this.enclosedCache = (function () {
      ...
      return {
        ...
        get: function (cacheKey, expiryAdjustmentSeconds) {
          ...
          var existingCacheKey = findExistingCacheKey(cacheKey, Object.keys(cache));
    ...
    return __generator(this, function (_a) {
      switch (_a.label) {
        case 0:
          ...
          _a.label = 1;
        case 1:
          if (!(i < maxNumberOfRetries)) return [3, /*break*/
          4];
          return [4, /*yield*/
          cb()];
        case 2:
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            ...
            return [4, /*yield*/
            runPopup(url, __assign(__assign({}, config), {
  ...
  Auth0Client.prototype.getUser = function (options) {
    ...
    return __awaiter(this, void 0, void 0, function () {
      ...
      return __generator(this, function (_a) {
        ...
        cache = this.cache.get(new CacheKey({
          client_id: this.options.client_id,
          audience: audience,
          scope: scope
        }));
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4, /*yield*/
            this.buildAuthorizeUrl(urlOptions)];
          case 1:
            url = _a.sent();
      ...
      return __generator(this, function (_b) {
        switch (_b.label) {
          case 0:
            ...
            return [4, /*yield*/
            oauthToken(tokenOptions, this.worker)];
          case 1:
            authResult = _b.sent();
        ...
        switch (_b.label) {
          case 0:
            ...
            getAccessTokenFromCache = function () {
              var cache = _this.cache.get(new CacheKey({
          ...
          case 2:
            ...
            if (!this.options.useRefreshTokens) return [3, /*break*/
            4];
            return [4, /*yield*/
          ...
          case 4:
            return [4, /*yield*/
            this._getTokenFromIFrame(getTokenOptions)];
          case 5:
            _a = _b.sent();
            _b.label = 6;
          case 6:
            authResult = _a;
            this.cache.save(__assign({
              client_id: this.options.client_id
            }, authResult));
            this.cookieStorage.save('auth0.is.authenticated', true, {
              daysUntilExpire: this.sessionCheckExpiryDays
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            return [4, /*yield*/
            this.loginWithPopup(options, config)];
          case 1:
            _a.sent();
            cache = this.cache.get(new CacheKey({
              scope: options.scope,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          ...
          case 1:
            code_challengeBuffer = _a.sent();
            code_challenge = bufferToBase64UrlEncoded(code_challengeBuffer);
            params = this._getParams(options, stateIn, nonceIn, code_challenge, options.redirect_uri || this.options.redirect_uri || window.location.origin);
            url = this._authorizeUrl(__assign(__assign({}, params), {
              prompt: 'none',
              response_mode: 'web_message'
            }));
          ...
          case 2:
            _a.trys.push([2, 5, , 6]);
            return [4, /*yield*/
            runIframe(url, this.domainUrl, timeout)];
          case 3:
            codeResult = _a.sent();
            if (stateIn !== codeResult.state) {
              throw new Error('Invalid state');
            ...
            return [4, /*yield*/
            oauthToken(__assign(__assign(__assign({}, this.customOptions), customOptions), {
              scope: scope,
              audience: audience,
              baseUrl: this.domainUrl,
              client_id: this.options.client_id,
      ...
      return __generator(this, function (_a) {
        switch (_a.label) {
          case 0:
            ...
            if (!((!cache || !cache.refresh_token) && !this.worker)) return [3, /*break*/
            2];
            return [4, /*yield*/
            this._getTokenFromIFrame(options)];
          case 1:
            return [2, /*return*/
            _a.sent()];
          case 2:
            ...
            timeout = typeof options.timeoutInSeconds === 'number' ? options.timeoutInSeconds * 1000 : null;
            _a.label = 3;
          case 3:
            _a.trys.push([3, 5, , 8]);
            return [4, /*yield*/
            oauthToken(__assign(__assign(__assign(__assign(__assign({}, this.customOptions), customOptions), {
              audience: audience,
              scope: scope,
              baseUrl: this.domainUrl,
              client_id: this.options.client_id,
          ...
          case 5:
            e_2 = _a.sent();
            if (!(// The web worker didn't have a refresh token in memory so
            // fallback to an iframe.
            e_2.message === MISSING_REFRESH_TOKEN_ERROR_MESSAGE || // A refresh token was found, but is it no longer valid.
            // Fallback to an iframe.
            e_2.message && e_2.message.indexOf(INVALID_REFRESH_TOKEN_ERROR_MESSAGE) > -1)) // The web worker didn't have a refresh token in memory so
            // fallback to an iframe.
            return [3, /*break*/
            7];
            return [4, /*yield*/
...
},{"fast-text-encoding":"3O5WR","browser-tabs-lock":"58Zpi","unfetch":"32vSQ","es-cookie":"4Ta94"}],"3O5WR":[function(require,module,exports) {
...
},{}],"58Zpi":[function(require,module,exports) {
"use strict";
...
},{"./processLock":"1vyHI"}],"1vyHI":[function(require,module,exports) {
"use strict";
Object.defineProperty(exports, "__esModule", { value: true });
...
},{}],"32vSQ":[function(require,module,exports) {
...
},{}],"4Ta94":[function(require,module,exports) {
"use strict";
...
},{}]},["7nvr3","Ly4Gq"], "Ly4Gq", "parcelRequire42d0")
